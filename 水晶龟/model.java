...
public class crystal_turtleAnimation {
	public static final AnimationDefinition walk_XingZou = AnimationDefinition.Builder.withLength(0.75F).looping()
		.addAnimation("crystal", new AnimationChannel(AnimationChannel.Targets.SCALE, 
	...
	public static final AnimationDefinition ShrinkingShell_SuoKe = AnimationDefinition.Builder.withLength(0.5F)
		...
		.addAnimation("L2", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(0.5F, KeyframeAnimations.posVec(-2.0F, 1.0F, 11.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("R2", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			new Keyframe(0.0F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR),
	...
	public static final AnimationDefinition ExtendHead_Shentou = AnimationDefinition.Builder.withLength(0.75F)
		...
		.addAnimation("L2", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(0.25F, KeyframeAnimations.degreeVec(0.0F, 90.0F, 90.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.5F, KeyframeAnimations.degreeVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.LINEAR)
		))
		.addAnimation("L2", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			new Keyframe(0.0F, KeyframeAnimations.posVec(-2.0F, 1.0F, 11.0F), AnimationChannel.Interpolations.LINEAR),
			new Keyframe(0.25F, KeyframeAnimations.posVec(-2.0F, 1.0F, -3.0F), AnimationChannel.Interpolations.LINEAR),
