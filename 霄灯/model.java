...
public class xiao_lanternAnimation {
	public static final AnimationDefinition load = AnimationDefinition.Builder.withLength(16.0F).looping()
		.addAnimation("floot", new AnimationChannel(AnimationChannel.Targets.ROTATION, 
			...
			new Keyframe(6.0F, KeyframeAnimations.degreeVec(2.4976F, 0.109F, 2.5024F), AnimationChannel.Interpolations.CATMULLROM),
			new Keyframe(8.0F, KeyframeAnimations.degreeVec(0.0F, 0.218F, 2.4952F), AnimationChannel.Interpolations.CATMULLROM),
			...
			new Keyframe(14.0F, KeyframeAnimations.degreeVec(-0.0024F, 0.327F, -2.5024F), AnimationChannel.Interpolations.CATMULLROM),
		...
		.addAnimation("all", new AnimationChannel(AnimationChannel.Targets.POSITION, 
			...
			new Keyframe(12.0F, KeyframeAnimations.posVec(0.0F, -2.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
